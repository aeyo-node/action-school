        ...
        <div id="plane-morph" ref={containerRef} className="relative h-[400vh] w-full z-20 bg-rich-black">
            <div className="sticky top-0 h-screen w-full overflow-hidden">
                ...
                <motion.div
                    ...
                    className="absolute bottom-[28%] sm:bottom-[25%] left-4 sm:left-6 md:left-12 z-[3] pointer-events-none"
                >
                    <h3 className="text-base sm:text-lg md:text-2xl font-light tracking-tight text-white/95 leading-snug drop-shadow-md">
                ...
                <motion.div
                    ...
                    className="absolute top-20 sm:top-24 left-4 sm:left-6 md:left-12 z-[3] pointer-events-none max-w-[90%]"
                >
                    <p className="text-[10px] sm:text-xs text-white/50 font-medium tracking-[0.3em] uppercase mb-1">Action School</p>
                    <h2 className="text-[9vw] sm:text-[7vw] md:text-[5vw] font-bold tracking-tighter text-white leading-[0.8] drop-shadow-2xl">
                        Ultra-Light
                    </h2>
                </motion.div>
                ...
                >
                    <div className="grid grid-cols-2 gap-x-6 gap-y-3 sm:gap-x-10 sm:gap-y-5 bg-rich-black/35 backdrop-blur-md border border-white/10 p-4 sm:p-6 rounded-xl max-w-md">
                        ...
                        <div>
                            ...
                            <p className="text-xs sm:text-sm md:text-base font-bold text-white">360° PANORAMIC</p>
                        </div>
                        <div>
                            <p className="text-[8px] sm:text-[9px] font-bold uppercase tracking-[0.2em] text-white/40 mb-0.5">Requirements</p>
                            <p className="text-xs sm:text-sm md:text-base font-bold text-white">NO EXPERIENCE</p>
                        </div>
                        <div>
                            <p className="text-[8px] sm:text-[9px] font-bold uppercase tracking-[0.2em] text-white/40 mb-0.5">Safety</p>
                            <p className="text-xs sm:text-sm md:text-base font-bold text-white">100% SECURE</p>
                        </div>
                    </div>
                </motion.div>
                ...
                <motion.div
                    ...
                    className="absolute bottom-6 sm:bottom-8 right-4 sm:right-6 md:right-12 z-[4] pointer-events-auto"
                >
