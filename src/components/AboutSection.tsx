...
export default function AboutSection() {
    return (
        <section id="about" className="w-full py-24 px-6 md:px-12 bg-white text-rich-black relative z-10">
            <div className="max-w-5xl mx-auto flex flex-col md:flex-row gap-12 items-center">
                ...
                >
                    <div className="flex items-center gap-4">
                        <div className="w-12 h-px bg-aviation-blue" />
                        <span className="text-sm font-bold uppercase tracking-widest text-aviation-blue">Our Mission</span>
                    </div>
